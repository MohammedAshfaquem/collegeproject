...
class Homepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<imagemovingmodel> imagelist = [
      imagemovingmodel(image: 'lib/images/foodimage.jpg', text: '1'),
      imagemovingmodel(image: 'lib/images/fooddonate2.jpg', text: '2'),
      imagemovingmodel(image: 'lib/images/foodhelpda.jpg', text: '3'),
    ];
    final controller = Provider.of<Donatecontroler>(listen: false, context);
        final imagcontroller = Provider.of<imgcontroller>(listen: false, context);
                    ...
                    ClipRRect(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          height: 60.h,
                          width: 60.w,
                          child: imagcontroller.image != null
                        ? Image.file(
